...
For previews of all of the available color customization options, please check the "Previews" folder.
...
For example, if you wanted purple active holds, you would go to the Customizations>Holds>Active>Purple folder, and place the .PNG files into the noteskin's folder.
